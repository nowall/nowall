...
var proxy = module.exports = function(options) {
  ...
  var handle = function(req, res, next) {
    ...
    var clientRequest = new ProxyRequest(logger, req).request(
      function(requestOpts, clientResponse) {
        try {
          if(utils.isVIPResource(requestOpts, clientResponse)) {
            clientRequest.abort();
            res.statusCode = 403;
  ...
  ****************/
  ...
  ProxyRequest.prototype = {
    ...
    request: function(callback) {
      ...
      var request = this.scheme.request(_options, function(resp) {
          callback(_options, resp);
      });
