...
describe('encodev2', function(){
    ...
    describe('decodeUrl', function() {
        ...
        it('should fix for dynamic', function() {
            ...
            // TODO should encode to 'https://ssl.nowall.be/recaptcha/api/?px!=https:www.google.com!'
            // then in js, url + 'js/recaptcha.js'
            // 'https://ssl.nowall.be/recaptcha/api/?px!=https:www.google.com!js/recaptcha.js'
            encode.decodeUrl('https://ssl.nowall.be/recaptcha/api/?px!=https:www.google.comjs/recaptcha.js')
              .should.equal('https://www.google.com/recaptcha/api/js/recaptcha.js')
        })
    });
